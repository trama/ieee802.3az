...
Define_Module(EtherPowAppSrv);

simsignal_t EtherPowAppSrv::sentPkSignal = SIMSIGNAL_NULL;
simsignal_t EtherPowAppSrv::rcvdPkSignal = SIMSIGNAL_NULL;

void EtherPowAppSrv::initialize()
{
...
void EtherPowAppSrv::handleMessage(cMessage *msg)
{
...
void EtherPowAppSrv::sendPacket(cPacket *datapacket, const MACAddress& destAddr)
{
...
void EtherPowAppSrv::registerDSAP(int dsap)
{
