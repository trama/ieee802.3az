...
{
    this->lpiClientID_var = other.lpiClientID_var;
}

void Hello::parsimPack(cCommBuffer *b)
{
    ::cPacket::parsimPack(b);
    doPacking(b,this->lpiClientID_var);
}

void Hello::parsimUnpack(cCommBuffer *b)
{
    ::cPacket::parsimUnpack(b);
    doUnpacking(b,this->lpiClientID_var);
}

int Hello::getLpiClientID() const
{
    return lpiClientID_var;
}

void Hello::setLpiClientID(int lpiClientID)
{
    this->lpiClientID_var = lpiClientID;
}
...
HelloDescriptor::HelloDescriptor() : cClassDescriptor("Hello", "cPacket")
{
}
...
int HelloDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='l' && strcmp(fieldName, "lpiClientID")==0) return base+0;
...
std::string HelloDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    Hello *pp = (Hello *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getLpiClientID());
        default: return "";
    }
}
...
bool HelloDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    Hello *pp = (Hello *)object; (void)pp;
    switch (field) {
        case 0: pp->setLpiClientID(string2long(value)); return true;
